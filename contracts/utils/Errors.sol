...
library Errors {
    ...
    enum Code {
        ...
        MORTGAGE_VAULT_POOL_MORTGAGED, // 5: "Pool mortgaged"
        ...
        POOL_PROXY_FACTORY_INVALID_MORTGAGE_TIER, // 75: "Mortgage tier not set in comptroller"
        POOL_PROXY_STORAGE_UTILS_INVALID_RESERVE_EXECUTION_RATE, // 76: "Invalid reserve execution rate"
