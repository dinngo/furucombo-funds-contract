...
library Errors {
    ...
    enum Code {
        ...
        RWRAPPED_TOKEN_ZERO_ASSET_ADDRESS, // 64:  "Zero asset address"
        RWRAPPED_TOKEN_ZERO_UNDERLYING_ADDRESS, // 65: "Zero underlying address"
        RWRAPPED_TOKEN_ASSET_IS_NOT_SET, // 66: "Asset is not set"
        RWRAPPED_TOKEN_UNDERLYING_IS_NOT_SET, // 67: "Underlying is not set"
        ASSET_MODULE_DIFFERENT_ASSET_REMAINING, // 68: "Different asset remaining"
        PERFORMANCE_FEE_MODULE_FEE_RATE_SHOULD_BE_LESS_THAN_FEE_BASE, // 69: "Fee rate should be less than 100%"
        PERFORMANCE_FEE_MODULE_CRYSTALLIZATION_PERIOD_TOO_SHORT, // 70: "Crystallization period too short"
