...
library Errors {
    ...
    enum Code {
        ...
        FUND_PROXY_STORAGE_UTILS_LEVEL_IS_SET, // 14: "Level is set"
        FUND_PROXY_STORAGE_UTILS_ZERO_LEVEL, // 15: "Level should not be 0"
        FUND_PROXY_STORAGE_UTILS_COMPTROLLER_IS_INITIALIZED, // 16: "Comptroller is initialized"
        FUND_PROXY_STORAGE_UTILS_ZERO_COMPTROLLER_ADDRESS, // 17: "Comptroller should not be zero address"
        ...
        FUND_PROXY_STORAGE_UTILS_ZERO_VAULT, // 26: "Vault should not be zero address"
        FUND_PROXY_STORAGE_UTILS_ZERO_SETUP_ACTION_ADDRESS, // 27: "Setup should not be zero address"
