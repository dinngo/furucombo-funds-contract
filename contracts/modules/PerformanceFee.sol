...
abstract contract PerformanceFee {
    ...
    uint256 private constant FEE_DENOMINATOR = _BASIS_POINT * FEE_PERIOD;
    ...
    function _setPerformanceFeeRate(uint256 feeRate)
        ...
        returns (int128)
    {
        require(feeRate < _BASIS_POINT, "rate should be less than 100%");
        _feeRate64x64 = feeRate.divu(_BASIS_POINT);
