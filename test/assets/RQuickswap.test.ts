...
describe('RQuickSwap', function () {
  ...
  describe('calculate asset value ', function () {
    it('normal', async function () {
      ...
      console.log(
        'tokenOuts[0]',
        (await tokenA.balanceOf(user.address)).sub(tokenAUserBefore).toString()
      );
      console.log(
        'tokenOuts[1]',
        (await tokenB.balanceOf(user.address)).sub(tokenBUserBefore).toString()
      );
      console.log('token0Value', tokenAValue.toString());
      console.log('token1Value', tokenBValue.toString());
