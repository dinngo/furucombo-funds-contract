...
describe('QuickSwap Swap', function () {
  ...
  describe('Matic to Token', function () {
    ...
    describe('Exact input', function () {
      ...
      it('matic token', async function () {
        ...
        await expect(
          proxy.connect(user).execMock(to, data, { value: value })
        ).to.be.revertedWith('HQuickSwap_swapExactETHForTokens: Unspecified');
      });
    });
    ...
    describe('Exact output', function () {
      ...
      it('matic token', async function () {
        ...
        await expect(
          proxy.connect(user).execMock(to, data, { value: value })
        ).to.be.revertedWith('HQuickSwap_swapETHForExactTokens: Unspecified');
      });
    });
  });
